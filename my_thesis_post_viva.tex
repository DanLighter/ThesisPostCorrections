...
\caption{All four basic statistical parameters within the VOI for either tHb, $mathrm{S_A}$, $mathrm{StO_2}$ or $mathrm{H_2O}$, comparing values for a single healthy participant at day 0, at which point a traumatic injury had been sustained to the right PIP IV with the remaining joints unaffected, and the same joints following 63 days of recovery.}
